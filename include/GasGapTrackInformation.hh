...
// ********************************************************************
//
/// \file runAndEvent/GasGap/include/GasGapTrackInformation.hh
/// \brief Definition of the GasGapTrackInformation class
//
//
// $Id$
//

#ifndef GasGapTrackInformation_h
#define GasGapTrackInformation_h 1
...
class GasGapTrackInformation : public G4VUserTrackInformation 
{
public:
  GasGapTrackInformation();
  GasGapTrackInformation(const G4Track* aTrack);
  GasGapTrackInformation(const GasGapTrackInformation* aTrackInfo);
  virtual ~GasGapTrackInformation();
   
  inline void *operator new(size_t);
  inline void operator delete(void *aTrackInfo);

  GasGapTrackInformation& operator =(const GasGapTrackInformation& right);
...
extern G4Allocator<GasGapTrackInformation> aTrackInformationAllocator;

inline void* GasGapTrackInformation::operator new(size_t)
{ void* aTrackInfo;
  aTrackInfo = (void*)aTrackInformationAllocator.MallocSingle();
  return aTrackInfo;
}

inline void GasGapTrackInformation::operator delete(void *aTrackInfo)
{ aTrackInformationAllocator.FreeSingle((GasGapTrackInformation*)aTrackInfo);}
