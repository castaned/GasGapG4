...
// ********************************************************************
//
/// \file field/field02/src/GasGapElectricFieldSetup.cc
/// \brief Implementation of the GasGapElectricFieldSetup class
//
// $Id$
//
...
#include "GasGapFieldMessenger.hh"
...
GasGapElectricFieldSetup::GasGapElectricFieldSetup()
  : fFieldManager(0),
    fChordFinder(0), 
    fEquation(0),
    fEMfield(0),
    ...
    fMinStep(0.010*mm)  // minimal step of 10 microns
{
  ...
  fFieldMessenger = new GasGapFieldMessenger(this) ;  
  UpdateField();
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

GasGapElectricFieldSetup::GasGapElectricFieldSetup(G4ThreeVector fieldVector)
  : fFieldManager(0),
    fChordFinder(0), 
    fEquation(0),
    fEMfield(0),
...
void GasGapElectricFieldSetup::UpdateField()
{
...
void GasGapElectricFieldSetup::SetStepper()
{
...
void GasGapElectricFieldSetup::SetFieldValue(G4double fieldValue)
{
...
void GasGapElectricFieldSetup::SetFieldValue(G4ThreeVector fieldVector)
{
...
G4FieldManager*  GasGapElectricFieldSetup::GetGlobalFieldManager()
{
//  Utility method
