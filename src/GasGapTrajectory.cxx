...
// ********************************************************************
//
/// \file runAndEvent/GasGap/src/GasGapTrajectory.cc
/// \brief Implementation of the GasGapTrajectory class
//
//
// $Id$
//
...
#include "GasGapTrackInformation.hh"

G4Allocator<GasGapTrajectory> myTrajectoryAllocator;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo...... 
GasGapTrajectory::GasGapTrajectory(const G4Track* aTrack)
:G4VTrajectory()
{
   ...
   GasGapTrackInformation* trackInfo
    = (GasGapTrackInformation*)(aTrack->GetUserInformation());
   ...
   { fParentID = -1; }
   fPositionRecord = new GasGapTrajectoryPointContainer();
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo...... 
GasGapTrajectory::~GasGapTrajectory()
{
  size_t i;
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo...... 
void GasGapTrajectory::ShowTrajectory(std::ostream& os) const
{
  os << G4endl << "TrackID =" << fTrackID 
   ...
   for( size_t i=0 ; i < fPositionRecord->size() ; i++){
	 ...
	 //       << " Position x = " << aTrajectoryPoint->GetPosition().getX()<< G4endl;
   }
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo...... 
void GasGapTrajectory::DrawTrajectory(G4int /*i_mode*/) const
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo...... 
const std::map<G4String,G4AttDef>* GasGapTrajectory::GetAttDefs() const
{
  G4bool isNew;
  std::map<G4String,G4AttDef>* store
    = G4AttDefStore::GetInstance("GasGapTrajectory",isNew);
  if (isNew) {
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo...... 
std::vector<G4AttValue>* GasGapTrajectory::CreateAttValues() const
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo...... 
void GasGapTrajectory::AppendStep(const G4Step* aStep)
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo...... 
void GasGapTrajectory::MergeTrajectory(G4VTrajectory* secondTrajectory)
{
  if(!secondTrajectory) return;

  GasGapTrajectory* seco = (GasGapTrajectory*)secondTrajectory;
