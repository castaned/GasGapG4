...
GasGapEventActionMessenger::GasGapEventActionMessenger(GasGapEventAction* EA)
:EventAction(EA)
{
...
void GasGapEventActionMessenger::SetNewValue(G4UIcommand* command, G4String newValues)
{
