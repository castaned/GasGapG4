...
void SteppingAction::UserSteppingAction(const G4Step* aStep)
{
  ...
  //  if(volName!="GasGap") return;

  G4cout<<"                               "<<G4endl;
  G4cout<<"                               "<<G4endl;
  G4cout<<"   Volume from Stepping        "<<volName<<G4endl;
  G4cout<<" /Enters UserSteppingAction    "<<G4endl;
  G4cout<<" /Enters UserSteppingAction    "<<G4endl;
  G4cout<<" /Enters UserSteppingAction    "<<G4endl;
  G4cout<<" /Enters UserSteppingAction    "<<G4endl;
  G4cout<<" /Enters UserSteppingAction    "<<G4endl;
  ...
  TrGEMAnalysis::GetInstance()->AddnSec(nstep,nsec);
  ...
  for (size_t lp=0; lp<(*secondary).size(); lp++) {
    ...
    G4cout<<" charge from SteppingAction   "<<charge<<G4endl;
    G4cout<<" type   from SteppingAction   "<<type<<G4endl;
    G4cout<<" name   from SteppingAction   "<<name<<G4endl;
