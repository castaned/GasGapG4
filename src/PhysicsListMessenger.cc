...
:fPhysicsList(pPhys)
{   
  // fECmd = new G4UIcmdWithADoubleAndUnit("/gasgap/phys/setMaxE",this);  
  ...
  // fEBCmd = new G4UIcmdWithAnInteger("/gasgap/phys/setNbinsE",this);  
  ...
  // fCBCmd = new G4UIcmdWithAnInteger("/gasgap/phys/setNbinsCl",this);  
  ...
  fListCmd = new G4UIcmdWithAString("/testgas/phys/addPhysics",this);  
