...
HistoManager::HistoManager()
  :rootFile(0),ntupl(0), Eabs(0),Ebeam(0),Zbeam(0)
...
//  // histo[1] = new TH1D("1", "Energy beam particle", 100, 0., 200*CLHEP::GeV);
//  // if (!histo[1]) G4cout << "\n can't create histo 1" << G4endl;
//  // histo[2] = new TH1D("2", "Position z beam particle", 100, -2., 2*CLHEP::cm);
//  // if (!histo[1]) G4cout << "\n can't create histo 1" << G4endl;
//  //  histo[3] = new TH1D("3", "Edep in GasGap", 100, 0., 800*CLHEP::MeV);
//  // if (!histo[1]) G4cout << "\n can't create histo 1" << G4endl;
...
//  // ntupl->Branch("Ebeam", &Ebeam, "Ebeam/D");
//  // ntupl->Branch("Zbeam", &Zbeam, "Zbeam/D");
...
// void HistoManager::FillNtuple(G4double energyAbs, G4double Ebeam,
//                               G4double Zbeam )
// {
//  // Eabs = energyAbs;
//  // Egap = energyGap;
