...
// ********************************************************************
//
/// \file field/field02/src/GasGapFieldMessenger.cc
/// \brief Implementation of the GasGapFieldMessenger class
//
// $Id$
// 
...
GasGapFieldMessenger::GasGapFieldMessenger(GasGapElectricFieldSetup* fieldSetup)
 : G4UImessenger(),
...
{ 
  ...
  fFieldDir->SetGuidance("GasGap field tracking control.");
...
GasGapFieldMessenger::~GasGapFieldMessenger()
{
  delete fStepperCmd;
  delete fElFieldCmd;
  delete fMinStepCmd;
...
void GasGapFieldMessenger::SetNewValue( G4UIcommand* command, G4String newValue)
{ 
